...
def convert_amos_task1(amos_base_dir: str, nnUNet_raw: str, nnunet_dataset_id: int = 218):
    """
...
if __name__ == '__main__':
    ...
    def create_argparser():
        defaults = dict(
            input_folder="G:/YangLab_FANN-main/data/EXACT09/LIDC",
            # data_dir="/jmain02/home/J2AD015/axf04/xxx16-axf04/caiwen/ATM22_cut_1_64_64/train/",
            nnUNet_raw = 'D:/2023 code/nnUNet-master/dataset/uuUNet_raw',
            d=False,
        )
        parser = argparse.ArgumentParser()
    ...
    convert_amos_task1(amos_base, args.nnUNet_raw, args.d)
